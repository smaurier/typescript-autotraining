...
//
// type MyPartial<T> = ???
type MyPartial<T> = any; // <-- Remplacez
...
type MyPick<T, K extends keyof T> = any; // <-- Remplacez
...
//
// type MyExclude<T, U> = ???
type MyExclude<T, U> = any; // <-- Remplacez
...
type MyNonNullable<T> = any; // <-- Remplacez
...
type CreateUserInput = any; // <-- Remplacez
...
type ReadonlyUser = any; // <-- Remplacez
